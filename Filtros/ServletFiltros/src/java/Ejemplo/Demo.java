 ...
 * @author maxim
 */
@WebFilter(filterName = "Demo", servletNames = {"Servlet"}, dispatcherTypes = {DispatcherType.REQUEST})
public class Demo implements Filter {
    ...
    private static class HttpServletRequest {
        ...
        private Object getParameter(String fecha) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }

        private String getParameter(String fecha) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
    }
    ...
    private static class HttpServletResponse {
        ...
        private void sendRedirect(String htmlFormulariohtml) {
            throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
        }
